...
<head>
    ...
    <link rel="stylesheet" href="../Source/css/home.css?ver">
                      ...
                      <?php
                            ...
                            ?>
                                    ...
                                    $sql = "SELECT * FROM product WHERE id = $product_id";
                                      ...
                                      echo '<a href="../Real_Pj/Cart/cart.php?remove=' . $product_id . '" class="fas fa-times"></a>';
                                    ...
                                    ?>
                                      ...
                                      <a href="../Source/Cart/cart.php" class="btn">checkout cart</a>
                                <script>
